...
class TwoLayerNet:
    ...
    def loss(self, X, y=None):
        ...
        scores, cache_fc2 = fc_forward(out_relu, self.params['W2'], self.params['b2'])
        ...
        d_hidden, dW2, db2 = fc_backward(dscores, cache_fc2)
    
    
        d_relu = relu_backward(d_hidden, cache_relu)
    
   
        dX, dW1, db1 = fc_backward(d_relu, cache_fc1)
